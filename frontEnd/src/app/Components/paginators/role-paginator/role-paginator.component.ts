...
@Component({
  selector: 'role-paginator-nav',
  templateUrl: './role-paginator.component.html',
  styleUrls: ['./role-paginator.component.css']
})
export class RolePaginatorComponent implements OnInit, OnChanges {
